...
# since We want to have a multivariate data set with 500 observations and 150 variables. 
df1 = matrix(ncol = 150, nrow = 500)


# Here we have 5 classes and for each we have 30 variables (columns), 
...
#class_0, class_1, class_2, class_3 and class_4.


# Assign to each element of class_0 an element from bdgraph.sim 
# with special quality(random graph and prob = 0.2(shows the sparsity) and type = Gaussian). 
set.seed(1)
...
# with special quality(hub graph and type = Gaussian). 
set.seed(3)
